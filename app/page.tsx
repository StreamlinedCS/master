...
export default function Home() {
  return (
    ...
    >
      {/* Hero Section */}
      <section className="w-full py-12 md:py-24 lg:py-32 bg-gradient-to-r from-blue-50/80 to-green-50/80">
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-white bg-opacity-90" id="features">
        <div className="container px-4 md:px-6">
          ...
          <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 py-12 md:grid-cols-2 lg:grid-cols-4">
            <div className="flex flex-col items-center space-y-2 rounded-lg border p-4 shadow-sm bg-white">
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-white bg-opacity-90">
        <div className="container px-4 md:px-6">
          ...
          <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 py-12 md:grid-cols-2 lg:grid-cols-3">
            ...
            />
            <TestimonialCard
              quote="I've hired several cleaning companies but these guys are by far the best. Highly recommended."
              author="Linda"
      ...
      <section
        id="contact"
        className="w-full py-12 md:py-24 lg:py-32 bg-blue-50 bg-opacity-90"
      >
