  ...
  return (
    <main className="relative min-h-screen flex flex-col">
      ...
      <div className="relative z-10 flex-grow flex flex-col">
              ...
              <div className="flex flex-col justify-center space-y-4">
                ...
                <div className="flex flex-col gap-4 min-[400px]:flex-row">
                  <a
                    ...
                    rel="nofollow"
                    className="inline-block bg-blue-600 text-white uppercase font-medium rounded-md px-7 py-2 text-sm tracking-wider hover:bg-blue-700 transition"
                  >
                    Book now
                  </a>
        ...
        {/* Features Section */}
        <section className="w-full py-12 md:py-24 lg:py-32 bg-white/90 backdrop-blur-sm" id="features">
          <div className="container px-4 md:px-6 mx-auto">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-gray-700 md:text-xl lg:text-base xl:text-xl">
                  We combine professional expertise with attention to detail to deliver exceptional cleaning results.
                </p>
              </div>
            </div>
            <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 py-12 md:grid-cols-2 lg:grid-cols-4">
              <div className="flex flex-col items-center space-y-2 rounded-lg border p-4 shadow-sm bg-white/90 backdrop-blur-sm">
        ...
        {/* Services Section */}
        <section className="w-full py-12 md:py-24 lg:py-32 bg-gray-50/90 backdrop-blur-sm" id="services">
          <div className="container px-4 md:px-6 mx-auto">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
        ...
        {/* Contact Section */}
        <section className="w-full py-12 md:py-24 lg:py-32 bg-gray-50/90 backdrop-blur-sm" id="contact">
          <div className="container px-4 md:px-6 mx-auto">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-gray-700 md:text-xl lg:text-base xl:text-xl">
                  Ready to experience the difference? Reach out for quotes, questions, or bookings.
                </p>
              </div>
            </div>
            <ContactForm />
