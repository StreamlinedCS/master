  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundAttachment: "fixed", // optional: fixes background on scroll for nice effect
      }}
    >
      {/* Hero Section */}
            ...
            <div className="flex flex-col justify-center space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="flex space-x-4">
                  <Link href="https://www.facebook.com/streamlined.cleaning.solution.s.2025/?viewas=100000686899395" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800">
                    <Facebook className="h-6 w-6" />
                  </Link>
                  <Link href="https://twitter.com/CleaningSolu1" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800">
